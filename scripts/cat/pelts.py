...
class Pelt:
    ...
    pelt_colours = [
        ...
        'BLUE GINGER', 'GRAY GINGER', 'SILVER GINGER'
    ]
    pelt_c_no_white = [
    ...
    gray_colours = ['GRAY', 'SLATE', 'DARK GRAY', 'DARK SLATE', 'SILVER', 'SLATE GINGER']
    ...
    ginger_colours = ['GINGER', 'DARK GINGER', 'DARK ORANGE', 'WARM HONEY', 'SIENNA', 'BLUE GINGER', 'GRAY GINGER', 'SILVER GINGER']
