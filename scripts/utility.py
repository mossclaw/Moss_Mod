...
def generate_sprite(
    ...
    try:
        ...
        color_dict = {
            ...
            "SLATE": ["#bfc0c4", "#70727c", "#e5e5e5"],
            "DARK SLATE": ["#56555a", "#2b292c", "#959499"],
            "OBSIDIAN": ["#1c1b19", "#12100d", "#1c1b19"],
            "PALE SILVER": ["#f3ecea", "#453b3a", "#fafcff"],
            "CROW": ["#5c5463", "#2f2935", "#867b8c"],
            "RAVEN": ["#7b7696", "#2b2549", "#aaa4c6"],
            "CINDER": ["#a89189", "#493a37", "#e8e2d4"],
            "JADE": ["#8a958f", "#29322d", "#d2d5ca"],
            "GRANITE": ["#a1949b", "#4e3c4c", "#c6b8c0"],
            "SOOT BLACK": ["#32353e", "#101018", "#44474f"],
            "COLD SILVER": ["#e3e1e4", "#7a6c7d", "#f7f5f6"],
            "BLUE SILVER": ["#a8abcd", "#47405a", "#e3f2ff"],

            "PALE FIRE": ["#ffa041", "#903027", "#ffd37d"],
            "FIRE": ["#ec8b19", "#bd3604", "#f1b875"],
            "DARK FIRE": ["#c63e10", "#841b11", "#ffa041"],
            "PALE GOLD": ["#f9c999", "#e09e60", "#f9dcb4"],
            "YELLOW": ["#fdb772", "#d88533", "#fcd9a2"],
            "GOLD": ["#d7934d", "#ad530d", "#eabb8a"],
            "BRONZE": ["#eb772e", "#ae4500", "#fcbd87"],
            "ROSE": ["#e1bdaf", "#c15832", "#f1e3d7"],
            "LIGHT CREAM": ["#f1d5ba", "#e2b791", "#faede0"],
            "DARK CREAM": ["#e1ae75", "#bd7b39", "#eed1b4"],
            "PALE CINNAMON": ["#c17041", "#882f0c", "#e0af8a"],
            "CINNAMON": ["#a54e2c", "#7f2309", "#d6966c"],
            "DARK ORANGE": ["#b0671c", "#3b2724", "#e2cfba"],
            "PALE EMBER": ["#ffaf7c", "#ac3a18", "#ffd29b"],
            "EMBER": ["#eb9d5f", "#8c2b28", "#f6d6b2"],
            "WARM HONEY": ["#eab76e", "#bd4f03", "#f4e1b1"],
            "LIGHT EMBER": ["#fed2a5", "#bb4e27", "#fff4ee"],
            "BLUE GOLDEN": ["#f0c785", "#a9a18a", "#feefd2"],
            "SUNSHINE": ["#f7e0a7", "#c46032", "#f7ebd7"],
            "DARK EMBER": ["#993928", "#563a3b", "#dd9a6a"],
            "SILVER GINGER": ["#b3aba8", "#c67f59", "#eae2dd"],

            "COFFEE": ["#dfb892", "#75312d", "#fbebdb"],
            "SABLE": ["#9e623c", "#623214", "#d08b55"],
            "DARK SABLE": ["#8e4f29", "#4b1c01", "#c87b3f"],
            "BIRCH": ["#e3c8b7", "#a0693a", "#f4e4d3"],
            "PALE BROWN": ["#aa9991", "#7d6559", "#d7cbc6"],
            "ALMOND": ["#bfa088", "#896956", "#e8cdbd"],
            "ACORN": ["#c78350", "#924b12", "#dfb28b"],
            "LIGHT BROWN": ["#c49570", "#996235", "#d6b496"],
            "DARK BROWN": ["#593923", "#2c1c12", "#755640"],
            "COCOA": ["#87655e", "#402222", "#c7a59b"],
            "SANDY": ["#e5b082", "#ac6540", "#f5d7a9"],
            "SANDSTONE": ["#b4805f", "#8b7263", "#c79271"],
            "OAK": ["#b9937f", "#8c5f4f", "#e4d9cf"],
            "CEDAR": ["#ffd8b1", "#a66957", "#fff0d7"],
            "DEER": ["#a38f78", "#6d5744", "#e0cfb5"],
        }
        ...
        if base_name:
            ...
            if cat.pelt.name in ['Tortie', 'Calico']:
                marking = "marking_"
                marking += cat.pelt.tortie_base.capitalize()
                marking_tint = pygame.Surface((sprites.size, sprites.size)).convert_alpha()
                marking_tint.fill(color_dict[base_color][1])
                marking_pelt = sprites.sprites[marking + cat_sprite].copy().convert_alpha()
                marking_pelt.blit(marking_tint, (0, 0), special_flags=pygame.BLEND_RGB_MULT)
        ...
        if cat.pelt.name in ['Tortie', 'Calico']:
            ...
            tortie_pelt = "marking_"
            tortie_pelt += cat.pelt.tortie_pattern.capitalize()
